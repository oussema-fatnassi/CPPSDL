...
const string QUIT_BUTTON_NORMAL = "../assets/images/quit.svg";
const string QUIT_BUTTON_HOVER = "../assets/images/quit_hover.svg";
const string QUIT_BUTTON_PRESSED = "../assets/images/quit_pressed.svg";

const string LEFT_ARROW_NORMAL = "../assets/images/left_arrow.svg";
const string LEFT_ARROW_HOVER = "../assets/images/left_arrow_hover.svg";
const string LEFT_ARROW_PRESSED = "../assets/images/left_arrow_pressed.svg";

const string RIGHT_ARROW_NORMAL = "../assets/images/right_arrow.svg";
